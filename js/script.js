...
food = {x: 6, y: 7};
//alert("For Background Sound click on the mute icon (on the left side)");
function main(ctime){
...
function sound() {
    ...
    if (Image_Id.src.match("img/mute.png")) {
        Image_Id.src = "img/speaker.png";
        musicSound.play();
    }
    else {
        Image_Id.src = "img/mute.png";
        musicSound.pause();
    }
}
...
function gameEngine(){
    ...
    if (snakeArr[0].y=== food.y && snakeArr[0].x === food.x){  
        ...
        if(score>hiscore){
            ...
            hiscoreboard.innerHTML = "highscore: " + hiscore;
        }
